...
class VarDeclNode extends DeclNode {
    ...
    public void codeGen(){
        if(myId.sym().isGlobal()){
            ...
            Codegen.generateWithComment(".align ", "align on a word boundary", "2");
...
class FctnDeclNode extends DeclNode {
    ...
    public void codeGen() {
        ...
        int localSize = ((FctnSym)myId.sym()).getLocalsSize();
        if (localSize > 0) {
            Codegen.generate("subu", Codegen.SP, Codegen.SP, Integer.toString(localSize));
        }
        ...
        Codegen.generate("li", Codegen.V0, "10", "\t# load exit code for syscall");
        Codegen.generate("syscall", "\t\t\t# only do this for main");
    }
...
class IfStmtNode extends StmtNode {
    ...
    public void codeGen() {
        ...
        Codegen.generateWithComment("", "IF-THEN");
        Codegen.generate(".data");
        myExp.codeGen();
        Codegen.genPop(Codegen.T0);
...
class IfElseStmtNode extends StmtNode {
    ...
    public void codeGen(){
        ...
        myExp.codeGen();
        Codegen.genPop(Codegen.T0);
        Codegen.generate("beqz", Codegen.T0, elseLabel);
...
class WhileStmtNode extends StmtNode {
    ...
    public void codeGen(){
        ...
        myExp.codeGen();
        Codegen.genPop(Codegen.T0);
        Codegen.generate("beqz", Codegen.T0, endLabel);
...
class WriteStmtNode extends StmtNode {
    ...
    public void codeGen(){
        ...
        Codegen.generate("li", Codegen.V0, sizeCap);
...
class CallExpNode extends ExpNode {
    ...
    public void codeGen(){
        Codegen.generate("subu", Codegen.SP, Codegen.SP, ((FctnSym)myId.sym()).getParamsSize());
